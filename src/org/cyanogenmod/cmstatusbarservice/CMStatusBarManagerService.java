...
package org.cyanogenmod.cmstatusbarservice;
...
public class CMStatusBarManagerService extends Service {
    ...
    public void onCreate() {
        ...
        mContext.registerReceiverAsUser(mPackageIntentReceiver, UserHandle.ALL, pkgFilter, null,
                null);
            ...
            try {
                synchronized (mQSTileList) {
                    final ManagedServices.ManagedServiceInfo info
                            = mCustomTileListeners.checkServiceTokenLocked(listener);
